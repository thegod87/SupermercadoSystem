...
import power.tech.controlador.ListadoClienteController;
...
public class ListadoClienteVentana extends JDialog {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					ListadoClienteVentana dialog = new ListadoClienteVentana();
	...
	public ListadoClienteVentana() {
		...
		lblDesdeNombre.setBounds(72, 43, 53, 14);
		...
		lblDesdeApellido.setBounds(72, 73, 53, 14);
		...
		lblHastaNombre.setBounds(172, 26, 44, 14);
		...
		cbOrder.setBounds(569, 40, 142, 20);
		...
		btnFiltrar
				.setIcon(new ImageIcon(ListadoClienteVentana.class.getResource("/power/tech/img/filtrarlistado.png")));
		btnFiltrar.setFont(new Font("Tahoma", Font.BOLD, 11));
		btnFiltrar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
			}
		});
		btnFiltrar.setBounds(470, 66, 89, 28);
		...
		btnImprimir
				.setIcon(new ImageIcon(ListadoClienteVentana.class.getResource("/power/tech/img/imprimirlistado.png")));
		...
		btnSalir.setIcon(new ImageIcon(ListadoClienteVentana.class.getResource("/power/tech/img/salirlistado.png")));
		...
		label.setBounds(262, 43, 19, 14);
		getContentPane().add(label);

		label_1 = new JLabel("-");
		label_1.setHorizontalAlignment(SwingConstants.CENTER);
		label_1.setFont(new Font("Tahoma", Font.BOLD, 11));
		label_1.setBounds(262, 73, 19, 14);
